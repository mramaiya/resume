...
\jobdescription{
Inkchaser.com is a retail printing website launched in 45 days from conception by myself and one other server-side developer, with a fresh-out-of-college developer coming on board thirty days into the project. Prior to beginning development, none of us had any experience with Grails and minimal experience with web technologies. 

After launch we focused on building the site to be completely automated, including such things as:
  - A real-time file checking tool which provides immediate feedback to customers about quality regarding print files with respect to products ordered.
...
\jobduties{
\item Developed the entire web site
\item Set up a continuous integration server with automatic deployments to dev and qa servers.
\item Built automated functional tests on Internet Explorer and Firefox using Selenium-RC
\item Wrote shell scripts to automatically generate database migration scripts
\item Used SASS to ease modification of CSS
\item 
\item JQuery, SASS, CSS, YUI compresso
}
